...
/**
 * This class is a thread that plays a sound once.
 * This is used for powerups and one time instance
 * sounds.
 *
 * @author John Kim, Tanner Lai, Raymond Zhao
 */
public class OneWave extends Thread{
	 ...
	 */
    public OneWave(String wavfile, Position p){
        filename = wavfile;
        curPosition = p;
    }
